<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <!-- Password -->
        <div class="mt-4">
            <x-input-label class="text-white" for="password" :value="__('Master Password')" />
        ...
        <!-- Confirm Password -->
        <div class="mt-4">
            <x-input-label class="text-white" for="password_confirmation" :value="__('Confirm Master Password')" />
