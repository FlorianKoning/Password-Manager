      ...
      <form id="catagorie-form" method="GET" action="#">
        ...
        <div class="relative transform overflow-hidden rounded-lg bg-main px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-10 sm:w-full sm:max-w-xl sm:p-6">
            ...
            <div class="mt-5 sm:mt-6 sm:grid sm:grid-flow-row-dense sm:grid-cols-2 sm:gap-3">
              ...
              <button onclick="closeDialog('catagorie_dialog')" type="button" class="mt-3 inline-flex w-full justify-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-main shadow-sm ring-1 ring-inset sm:col-start-1 sm:mt-0">Cancel</button>
            </div>
          </div>
        </form>
      </div>
