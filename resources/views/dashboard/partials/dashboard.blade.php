            ...
            <div class="px-4 flex justify-between">
                ...
                <div class="min-w-80 min-h-24 rounded-lg">
                    <div class="flex gap-6 border-t border-white/5 px-4 py-6 sm:px-6 lg:px-8">
                        ...
                        <div>
                            <p class="mt-2 flex items-baseline gap-x-2">
                                <span class="text-4xl font-semibold tracking-tight">{{ $catagoie_count }}</span>
                            </p>
                            <p class="text-sm font-medium leading-6">Number of categories</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="min-w-80 min-h-24 rounded-lg">
                    <div class="flex gap-6 border-t border-white/5 px-4 py-6 sm:px-6 lg:px-8">
                        ...
                        <div>
                            <p class="mt-2 flex items-baseline gap-x-2">
                                <span class="text-4xl font-semibold tracking-tight">{{ $items_count }}</span>
                            </p>
                            <p class="text-sm font-medium leading-6">Number of items</p>
                        </div>
                    </div>
                </div>
                ...
                <div class="min-w-80 min-h-24 rounded-lg">
                    <div class="flex gap-6 border-t border-white/5 px-4 py-6 sm:px-6 lg:px-8">
                        ...
                        <div>
                            <p class="mt-2 flex items-baseline gap-x-2">
                                <span class="text-4xl font-semibold tracking-tight">{{ $favorite_count }}</span>
                            </p>
                            <p class="text-sm font-medium leading-6">Number of favorites</p>
                        </div>
                    </div>
                </div>
            </div>
