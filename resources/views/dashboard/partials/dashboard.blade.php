                ...
                @else 
                    <div class="min-w-80 min-h-24 rounded-lg">
                        <div class="flex gap-6 border-t border-white/5 px-4 py-6 sm:px-6 lg:px-8">
                            ...
                            <div> 
                                <p class="mt-2 flex items-baseline gap-x-2">
                                    <span class="text-4xl font-semibold tracking-tight text-main">{{ $item_safety }}%</span>
                                </p>  
                                <div class="flex flex-row gap-2">
                                    <p class="text-sm font-medium leading-6 text-main">
                                        Of items are not secure
                                    </p>
                                    <a href="{{ route('itemsSecurity.index') }}" class="text-sm font-medium leading-6 text-main hover:text-second ease-in-out transition cursor-pointer">
