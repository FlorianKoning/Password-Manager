    ...
    <div class="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b border-border bg-[#fff] px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8">
      ...
      <div class="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
        <form class="relative flex flex-1" action="#" method="GET">
          ...
          <input id="search-field" class="block h-full w-full bg-[#fff] border-0 py-0 pl-8 pr-0 text-border placeholder:text-border focus:ring-0 sm:text-sm" placeholder="Search..." type="search" name="search">
        </form>
        <div class="flex items-center gap-x-4 lg:gap-x-6">
          ...
          <!-- Profile dropdown -->
          <div class="flex">
            <img class="h-8 w-8 rounded-full bg-[#fff]" src="https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="Profile picture">
